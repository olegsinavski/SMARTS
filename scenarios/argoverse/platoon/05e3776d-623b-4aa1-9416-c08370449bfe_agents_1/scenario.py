...
PATH = "argoverse/data"
scenario_id = "05e3776d-623b-4aa1-9416-c08370449bfe"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [
    t.EndlessMission(begin=("road-331948877-331948775", 0, 76.3), start_time=1)
]
