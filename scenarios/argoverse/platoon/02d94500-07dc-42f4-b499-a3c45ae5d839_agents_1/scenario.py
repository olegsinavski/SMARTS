...
PATH = "argoverse/data"
scenario_id = "02d94500-07dc-42f4-b499-a3c45ae5d839"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [
    t.EndlessMission(begin=("road-375212287-375212279", 1, 56.7), start_time=1)
]
