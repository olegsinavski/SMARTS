...
PATH = "argoverse/data"
scenario_id = "01a51dff-2418-4d4e-b9db-a04657e8e663"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [
    t.EndlessMission(begin=("road-404832586-404832034", 0, 21.0), start_time=1.2)
]
