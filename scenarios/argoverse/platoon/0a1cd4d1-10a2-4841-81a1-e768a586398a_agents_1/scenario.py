...
PATH = "argoverse/data"
scenario_id = "0a1cd4d1-10a2-4841-81a1-e768a586398a"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [t.EndlessMission(begin=("road-450216082", 0, 7.3), start_time=2)]
# ego_id = 39986
...
gen_scenario(
    t.Scenario(
        ...
        scenario_metadata=t.ScenarioMetadata("39986", Colors.Blue),
    ),
