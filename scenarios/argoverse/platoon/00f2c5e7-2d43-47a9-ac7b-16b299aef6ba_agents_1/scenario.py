...
PATH = "argoverse/data"
scenario_id = "00f2c5e7-2d43-47a9-ac7b-16b299aef6ba"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [
    t.EndlessMission(
        begin=("road-202852582-202852449-202852762-202852674", 3, 32.0),
    )
]
# ego_id = None
...
gen_scenario(
    t.Scenario(
        ...
        scenario_metadata=t.ScenarioMetadata("42182", Colors.Blue),
    ),
