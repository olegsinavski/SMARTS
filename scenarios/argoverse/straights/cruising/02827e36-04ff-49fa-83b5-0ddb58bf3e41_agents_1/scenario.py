...
scenario_id = "02827e36-04ff-49fa-83b5-0ddb58bf3e41"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = Path("/home/kyber/argoverse/") / scenario_id  # e.g. Path("/home/user/argoverse/train/") / scenario_id

ego_mission = [
    t.Mission(
        t.Route(
            begin=("road-415013045-415013024-415013020", 2, 7.0),
            end=("road-415013045-415013024-415013020", 2, 27.3),
        )
    )
]
