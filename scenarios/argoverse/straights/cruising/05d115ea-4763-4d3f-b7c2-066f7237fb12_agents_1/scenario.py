...
scenario_id = "05d115ea-4763-4d3f-b7c2-066f7237fb12"  # e.g. "0000b6ab-e100-4f6b-aee8-b520b57c0530"
scenario_path = (
...
ego_mission = [
    t.Mission(
        t.Route(
            begin=("road-411053130-411053983-411053842", 0, 38.5),
            end=("road-411077501", 0, "max"),
        )
    )
]
