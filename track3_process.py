...
subprocess.check_output(f"cp -R {data_path} argoverse/data", shell=True)
# Create scenario file
scenario_path = f"scenarios/argoverse/platoon/{scenario_id}_agents_1"
subprocess.check_output(f"mkdir -p {scenario_path}", shell=True)

filepath = Path(f"scenarios/argoverse/platoon/{scenario_id}_agents_1/scenario.py")
